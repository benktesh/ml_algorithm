...
AZURE_OPENAI_ENDPOINT = os.getenv("AZURE_OPENAI_ENDPOINT", "https://projecthubopenai.openai.azure.com/")
AZURE_OPENAI_API_KEY = os.getenv("AZURE_OPENAI_API_KEY")
AZURE_OPENAI_API_VERSION = os.getenv("AZURE_OPENAI_API_VERSION", "2024-02-15-preview")
AZURE_DEPLOYMENT_NAME = os.getenv("AZURE_DEPLOYMENT_NAME", "gpt-5-nano")
...
class SimpleRAGSystem:
    ...
    def __init__(self, embedding_model="chroma", llm_model="azure"):
        ...
        try:
            if self.embedding_model == "azure":
                ...
                self.embedding_fn = embedding_functions.OpenAIEmbeddingFunction(
                    api_key=AZURE_OPENAI_API_KEY,
                    api_base=f"{AZURE_OPENAI_ENDPOINT}openai/deployments/{AZURE_EMBEDDING_DEPLOYMENT}",
                    api_type="azure",
                    api_version=AZURE_OPENAI_API_VERSION,
    ...
    def query_documents(self, query, n_results=3):
        ...
        try:
            ...
            print("Query results obtained." + str(results))
            return results
        except Exception as e:
    ...
    def generate_response(self, query, context):
        ...
        try:
            ...
            # Determine the model name based on the LLM type
            if self.llm_model == "azure":
